...
import { Star, MapPin, Search, DollarSign, User, Calendar } from "lucide-react"
  ...
  return (
    <div className="grid lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="lg:col-span-1 space-y-6 hidden lg:block">
            <Card>
                <CardHeader>
                    <CardTitle>Booking Made Simple</CardTitle>
                    <CardDescription>Find and book your appointment in three easy steps.</CardDescription>
                </CardHeader>
            ...
            <Card className="overflow-hidden">
                ...
                <CardContent className="p-4">
                    ...
                    <p className="text-sm text-muted-foreground">
                        Finding the right doctor is the first step on your health journey. We're here to connect you with trusted professionals.
                    </p>
                </CardContent>
            </Card>
        </div>
